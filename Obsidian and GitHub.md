...
---
## Шаг 3. Настраиваем компьютер Windows
...
2. Соберите ссылку по образцу, подставив свои данные:
   ```
   https://<ТОКЕН_GITHUBE>@github.com/<ИМЯ_ПОЛЬЗОВАТЕЛЯ_В_GITHUB>/<НАЗВАНИЕ_РЕПОЗИТОРИЯ>.git
   ```
   Пример:
   ```
...
4. Выполните команду клонирования со своей ссылкой:
   ```bash
   git clone https://<ТОКЕН_GITHUBE>@github.com/<ИМЯ_ПОЛЬЗОВАТЕЛЯ_В_GITHUB>/<НАЗВАНИЕ_РЕПОЗИТОРИЯ>.git
   ```
